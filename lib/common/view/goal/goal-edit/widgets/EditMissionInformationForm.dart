...
class EditMissionInformationForm extends StatefulWidget {
  TextEditingController _titleController;
  TextEditingController _contentController;
  GoalEditController controller;

  EditMissionInformationForm(
      this._titleController, this._contentController, this.controller);

  @override
  State<EditMissionInformationForm> createState() =>
      _EditMissionInformationFormState();
}

class _EditMissionInformationFormState
    extends State<EditMissionInformationForm> {
                            ...
                            try {
                              ...
                              if (e is InvalidInformationException) {
                                ...
                                widget._titleController.text =
                                    widget._titleController.text.substring(
                                        0,
                                        widget._titleController.text.length -
                                            1);
                              ...
                              if (e is InvalidInformationException) {
                                widget._contentController.text =
                                    widget._contentController.text.substring(
                                        0,
                                        widget._contentController.text.length -
                                            1);
                                ToastMessage().showtoast(e.cause);
                              }
                            }
