...
class OldEditApi with ChangeNotifier {
  ...
  Future<bool> addDisease(OldEditDiseaseRequest disease, int userIdx) async{
    ...
    var response = await http.post(
        Uri.parse(ADD_DISEASE_URL + userIdx.toString()),
        headers: {
  ...
  Future<bool> deleteDisease(int diseaseIdx, int userIdx) async{
    ...
    var response = await http.delete(
        Uri.parse(ROOT_API + "senior/disease/"  + diseaseIdx.toString() + "/of-senior/" + userIdx.toString() ),
        headers: {
          'Cookie': 'JSESSIONID=$session', // 세션을 쿠키로 전달
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  Future<bool?> editProfileByYoung(OldEditProfileRequest dto, int userIdx) async {
    ...
    var response = await http.patch(
        Uri.parse(OLD_EDIT_URL + userIdx.toString()),
        headers: {
          'Cookie': 'JSESSIONID=$session', // 세션을 쿠키로 전달
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  Future<bool> editProfileImageByYoung(String urlPath, int userIdx) async {
    ...
    // 폼 데이터 생성
    var formData =
    http.MultipartRequest('PATCH', Uri.parse(ROOT_API + "guardian/profile/image/of-senior/${userIdx.toString()}"));
  ...
  Future<bool?> editProfileByOld(OldEditProfileRequest dto) async {
    ...
    var response = await http.patch(
        Uri.parse(ROOT_API + "senior/profile"),
        headers: {
          'Cookie': 'JSESSIONID=$session', // 세션을 쿠키로 전달
          'Content-Type': 'application/json',
          'Accept': 'application/json',
  ...
  Future<bool> editProfileImageByOld(String urlPath) async {
    ...
    // 폼 데이터 생성
    var formData =
    http.MultipartRequest('PATCH', Uri.parse(ROOT_API + "senior/profile/image"));
