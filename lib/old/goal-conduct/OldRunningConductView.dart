...
class OldRunningConductView extends StatefulWidget {
  final Mission mission;


  OldRunningConductView(this.mission);

  @override
  _OldRunningConductViewState createState() => _OldRunningConductViewState();
}

class _OldRunningConductViewState extends State<OldRunningConductView> {
  ...
  Widget _buildDrugImage() {
    return Container(
      ...
      width: 200.w,
      height: 180.h,
      child: Image.asset(commonImagePath + "goal-conduct/walk.png"),
    );
  }
