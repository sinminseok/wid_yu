...
class BleOldHealthInformationView extends StatefulWidget {
  const BleOldHealthInformationView({Key? key}) : super(key: key);

  @override
  _BleOldHealthInformationViewState createState() => _BleOldHealthInformationViewState();
}

class _BleOldHealthInformationViewState extends State<BleOldHealthInformationView> {
