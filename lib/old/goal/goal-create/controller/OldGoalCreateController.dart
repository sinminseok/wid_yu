...
class OldGoalCreateController {
  //List<User> users = [TestUser("부모님1", TestHealth(12,12,12), true),TestUser("부모님2", TestHealth(12,12,12), true),TestUser("부모님3", TestHealth(12,12,12), true),TestUser("부모님3", TestHealth(12,12,12), true),TestUser("부모님3", TestHealth(12,12,12), true),];
