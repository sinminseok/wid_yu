...
class GoalCalendar extends StatefulWidget {

  OldGoalDetailController controller;


  GoalCalendar(this.controller);

  @override
  State<GoalCalendar> createState() => _GoalCalendarState();
}

class _GoalCalendarState extends State<GoalCalendar> {
