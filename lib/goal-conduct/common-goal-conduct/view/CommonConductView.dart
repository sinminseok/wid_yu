...
import 'package:wid_yu/goal-conduct/common-goal-conduct/controller/CommonConductController.dart';

import '../../../../common/utils/Color.dart';
import '../../../../common/utils/CustomText.dart';
import '../../../old/frame/OldFrameView.dart';
import '../../FinishConductView.dart';
import '../../walk-goal-conduct/controller/WalkConductController.dart';

class CommonConductView extends StatefulWidget {
  GoalResponse goal;
  bool isOld;

  CommonConductView(this.goal, this.isOld);

  @override
  State<CommonConductView> createState() => _CommonConductViewState();
}

class _CommonConductViewState extends State<CommonConductView> {

  late CommonConductController _controller;


  @override
  void initState() {
    _controller = CommonConductController(widget.goal);
  ...
  Widget _buildImage() {
    return Container(
      ...
      width: 200.w,
      height: 200.h,
      child: Image.asset("assets/images/mission/flag.png"),
    );
  }
          ...
          children: [
            ...
            Center(
                child: Container(
                    ...
                    child: Title3Text("목표 제목", kTextBlackColor))),
            Container()
          ],
        ),
      ),
