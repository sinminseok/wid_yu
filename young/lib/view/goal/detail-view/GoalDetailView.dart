                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: CircularPercentIndicator(
                          ...
                          progressColor: isToday ? wOrangeColor : wPurpleColor,
                        ),
                      ),
                    ],
                  ),
  ...
  Widget _buildMissionDate() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text("2023.09.23", style: TextStyle(color: kTextBlackColor, fontWeight: FontWeight.bold, fontSize: 16.sp)),
          Text("수요일", style: TextStyle(color: kTextBlackColor,fontSize: 15.sp)),
        ],
      ),
    );
  }
