import 'package:common/common-widget/mission/MissionWidget.dart';
...
class MissionGroupContainWidget extends StatefulWidget {
  const MissionGroupContainWidget({Key? key}) : super(key: key);

  @override
  _MissionGroupWidgetState createState() => _MissionGroupWidgetState();
}

class _MissionGroupWidgetState extends State<MissionGroupContainWidget> {
