...
import 'package:young/view/family-manager/popup/DeleteDiseasePopup.dart';
        ...
        child: Row(
          children: [
            Container(
              ...
              width: 15.h,
              height: 15.w,
              child: Icon(Icons.add, color: wTextBlackColor,),
            ),
            Container(
              margin: EdgeInsets.only(left: 10.w),
              child: Text("질병 추가", style: TextStyle(color: wTextBlackColor),),
            )
          ],
        ),
      ),
