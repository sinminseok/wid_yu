                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text("또 다른 부모님의 계정도\n추가로 생성할까요?",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18.sp),),
                          ),
                        ),
                        Container(
                                ...
                                onTap: (){
                                  Navigator.push(
                                      ...
                                      PageTransition(
                                          ...
                                          child: (OtherOldInformationView(old)  )));
                                },
                                child: Container(
                                  width: 156.w,
                                  height: 44.h,
                                  ...
                                  child: Center(
                                    child: Text("추가 생성하기",style: TextStyle(color: kTextWhiteColor, fontSize: 16.sp),),
                                  ),
                                ),
                              ),
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text("건너뛰기",style: TextStyle(color: kTextGreyColor, fontSize: 16.sp),),
                                  ),
                                ),
                              ),
                            ],
